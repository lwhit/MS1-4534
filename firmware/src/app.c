...
void APP_Tasks ( void )
{
    ...
    for(;;){
        ...
        //change byte to send then send it.
        appData.tx_byte = 'a';
        DRV_USART0_WriteByte (appData.tx_byte);   // Write character 'a' to USART driver instance 0
        
        //change byte to b then send it.
        appData.tx_byte = '0';
         ...
         *      appData.rx_byte = DRV_USART0_ReadByte ();   // Read a byte from USART driver instance 0
         * }*/ 
    }
}
